def get_params(argv='1'):
    ...
    if argv == '1':
        ...
        params['feat_label_dir'] = '/home/yujiezhu/code/sound_distance_estimation/data_new/processed/'
        ...
        params['patience'] = 40
        params['use_ind_data'] = True  # Is use one of the above datasets
        params['ind_data_train_test_split'] = [[11], [15], [12]]
        params['finetune_mode'] = True
        params['pretrained_model_weights'] = 'models/pretrained_dcase_event_detector.h5'
        ...
        params['patience'] = 40
        params['use_ind_data'] = True  # Is use one of the above datasets
        params['ind_data_train_test_split'] = [[3], [15], [15]]
        params['finetune_mode'] = True
        params['pretrained_model_weights'] = 'models/5_1_dev_split0_accdoa_mic_gcc_model.h5'
        params['perm_3_loss_type'] = 'thr_mape'
        params['perm_3_loss_mpe_type_thr'] = 0.4
